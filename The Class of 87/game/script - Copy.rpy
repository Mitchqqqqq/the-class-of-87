...
label start:
    ...
    "the sun blinded you as you woke up from your slumber"
    ...
    "you take the bus to school its rather uneventful"
    "the bus then proceeds to break down in the middle of the hood"
    scene hood
